...
<?php
    ...
    for ($i=0; $i < count($year); $i++) { 
        ...
        FROM work_details WHERE Prabhag_No = '".$prabhag."' && Year = '".$year[$i]."' GROUP BY Work_Type";
...
<div id="fh5co-about" style="padding-top: 20px;">
    <div class="container">

        <div class="text-center"><h2><strong>Ward Level</strong></h2></div><br>
        ...
        <div class="text-center">
            <br><h2><strong>Aggregated Expenses for 5 Years - (<?=moneyFormatIndia($total_amt); ?>)</strong></h2><br>
            ...
            <!-- <div class="btn-group btn-group-lg" role="group">
                ...
                <?php
                    foreach ($yearList as $key => $value) {
                        $y = str_replace(" - ", "-", $value);
                        $url = SITE_URL . "details/ward_level.php?y={$y}&p={$prabhag}"; 
                        ?>
